...
parser.add_argument('--input-data-dir', default='data/europarl/txt/en', type=str)
parser.add_argument('--output-train-dir', default='data/europarl_processed/train_data.pkl', type=str)
parser.add_argument('--output-test-dir', default='data/europarl_processed/test_data.pkl', type=str)
parser.add_argument('--output-vocab', default='data/europarl_processed/vocab.json', type=str)
